...
handlers.sessionCreate = function (data, callback) {
    ...
    if (data.method == 'get') {
        ...
        let templateData = {
            ...
            'head.description': 'Please enter you phone nubmer and password to access your account',
...
handlers._tokens.post = function (data, callback) {
    ...
    // Attach an observer to the measurements
    const obs = new PerformanceObserver(function(perfObserverList, observer) {
        measurements.push(perfObserverList.getEntriesByType('measure'));
    });
                ...
                _data.read('users', userPhone, function(err, userData) {
                    if (!err && userData) {
                        ...
                        if (userChecks.length < config.maxChecks) {
                            // Verify that the url given has dns entries (andd therefore can resolve)
